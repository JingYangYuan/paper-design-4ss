...
| 43 | `paper-design-concept-analysis-consultant` | `agents/concept-analysis-consultant.md` | 概念定义、边界案例、相邻概念与概念贡献复核 | Read, Grep |
| 44 | `paper-design-normative-argument-consultant` | `agents/normative-argument-consultant.md` | 规范前提、原则冲突、反例与制度含义复核 | Read, Grep |
| 45 | `paper-design-interpretive-history-consultant` | `agents/interpretive-history-consultant.md` | 文本语境、理论谱系与竞争诠释复核 | Read, Grep |
| 46 | `paper-design-argument-stress-test-consultant` | `agents/argument-stress-test-consultant.md` | Toulmin 论证链、限定语和最强反驳压力测试 | Read, Grep |
