...
- 必读流程参考: 先确认模式和研究取向，再按模式读取 `phases/01-frame-mode.md`、`02-storm-mode.md`、`03-design-mode.md`、`04-full-pipeline.md` 或 `05-quality-gates.md`；以最强反例、竞争解释或不可执行环节复核，不预设实证标准。
